...
os.environ['CUDA_VISIBLE_DEVICES'] = '6'  # set a GPU (with GPU Number)
...
TRAIN_COVER_DIR = "/data/liuxulong/SRNet_database/train-BOSS-BOWS-256-QF95-0.3p/train_cover/"
TRAIN_STEGO_DIR = "/data/liuxulong/SRNet_database/train-BOSS-BOWS-256-QF95-0.3p/train_stego/"

VALID_COVER_DIR = "/data/liuxulong/SRNet_database/train-BOSS-BOWS-256-QF95-0.3p/valid_cover/"
VALID_STEGO_DIR = "/data/liuxulong/SRNet_database/train-BOSS-BOWS-256-QF95-0.3p/valid_stego/"
...
LOG_DIR = "/data/liuxulong/SRNet_database/train-BOSS-BOWS-256-QF95-0.3p/logfile/"  # path for a log direcotry
load_path = LOG_DIR + 'Model_805000.ckpt'  # continue training from a specific checkpoint
...
boundaries = [800000]  # learning rate adjustment at iteration 400K
...
TEST_COVER_DIR = "/data/liuxulong/SRNet_database/train-BOSS-BOWS-256-QF95-0.3p/test_cover/"
TEST_STEGO_DIR = "/data/liuxulong/SRNet_database/train-BOSS-BOWS-256-QF95-0.3p/test_stego/"

test_batch_size = 20
LOG_DIR = "/data/liuxulong/SRNet_database/train-BOSS-BOWS-256-QF95-0.3p/logfile/"
LOAD_CKPT = LOG_DIR + 'Model_1000000.ckpt'  # loading from a specific checkpoint
